...
- Generic gamer-neon or cyberpunk styling.
...
Target WCAG 2.2 AA. Maintain keyboard access, visible focus states, sufficient text and control contrast, semantic structure, meaningful alternative text, responsive layouts, and reduced-motion behavior. The form must provide persistent labels, clear validation, actionable errors, and an understandable success state.
